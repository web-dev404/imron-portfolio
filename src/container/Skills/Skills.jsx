...
const Skills = () => {
	...
	return (
		<>
			{currentLanguage === 'ru' ? <h2 className={'head-text'}>Навыки & Опыт</h2> :
								...
								{experience.works.map(work => (
									<div key={work.name}>
										<motion.div
											...
											data-for={work.name}
										>
											<h4 className={'bold-text'}>{currentLanguage === 'ru' ? work.name : work.nameEng}</h4>
										...
										>
											{currentLanguage === 'ru' ? work.desc : work.descEng}
										</ReactTooltip>
									</div>
								))}
							</motion.div>
